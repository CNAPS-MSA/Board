...
@RestController
@RequestMapping("/api/board-kafka")
public class BoardKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BoardKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BoardKafkaResource(KafkaProperties kafkaProperties) {
